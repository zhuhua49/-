...
<html>
<head>
	<title>薪酬发放登记复核明细</title>
</head>
<body vLink="#006666" link="#003366" bgColor="#E0F0F8">
	  <center>
	  <s:form action="salary_payment_review">
		  ...
		  <td colspan="3"><s:textfield name="payment_form.registrar" value="%{#One.registrar}" id="registrar" /></td>
		  <td>登记时间：</td>
		  <td><s:property value="#One.registration_time" /></td>
		  </tr>
		  ...
		  <td>实发总额：</td>
		  <td><s:property value="#One.actual_sum" /></td>
		  </tr>
	      ...
	      <td><s:textfield name="payment[%{#st.index}].reward" value="%{#All.reward}" /></td>
	      <td><s:textfield name="payment[%{#st.index}].fine" value="%{#All.fine}" /></td>
	      </tr>
	      </s:iterator>
