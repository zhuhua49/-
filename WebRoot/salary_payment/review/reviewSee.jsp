...
<body vLink="#006666" link="#003366" bgColor="#E0F0F8">
	  当前等待复核的薪酬发放单总数：<s:property value="payment_formAll.size()"/>例
	 <center>
	  <table>
		<tr>
			<td>薪酬发放单编号</td>
		...
		<tr>
			...
			<td><a href="salary_payment_reviewOne.action?payment_form.paymentID=<s:property value="#ALL.paymentID" />" >复核</a></td>
		</tr>
		</s:iterator>
	  </table>
