...
<body vLink="#006666" link="#003366" bgColor="#E0F0F8">
	  <center>
		  ...
		  <td><s:textfield name="salary_standard.standard_name" value="%{#One.standard_name}" id="standard_name" readonly="true" /></td>
		  ...
		  <td><s:textfield name="salary_standard.setter" value="%{#One.setter}" id="setter" readonly="true" /></td>
	      <td><label for="registrar">登记人：</label></td>
		  <td><s:textfield name="salary_standard.registrar" value="%{#One.registrar}" id="registrar" readonly="true" /></td>
	      ...
	      <td><s:textfield name="salary_standard.base_pay" value="%{#One.base_pay}" id="base_pay" readonly="true" /></td>
	      </tr>
	      
	      <tr>
	      <td><label for="travel_allowance">交通补助：</label></td>
	      <td><s:textfield name="salary_standard.travel_allowance" value="%{#One.travel_allowance}" id="travel_allowance" readonly="true" /></td>
	      </tr>
	      
	      <tr>
	      <td><label for="lunch_allowance">午餐补助：</label></td>
	      <td><s:textfield name="salary_standard.lunch_allowance" value="%{#One.lunch_allowance}" id="lunch_allowance" readonly="true" /></td>
	      </tr>
	      
	      <tr>
	      <td><label for="communication_allowance">通信补助：</label></td>
	      <td><s:textfield name="salary_standard.communication_allowance" value="%{#One.communication_allowance}" id="communication_allowance" readonly="true" /></td>
	      </tr>
