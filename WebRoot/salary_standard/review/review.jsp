...
<html>
<head>
	<title>薪酬标准登记复核详情页</title>
</head>
<body vLink="#006666" link="#003366" bgColor="#E0F0F8">
	  <center>
	  <s:form action="salary_standard_review">
	      ...
	      <tr>
		  <td><label for="note">复核意见：</label></td>
		  <td colspan="3"><s:textarea name="salary_standard.note" id="note" cols="65" cssStyle="resize:none"/></td>
		  </tr>
